...
const ACTIVATION_TOKEN_SECRET = config.get('ACTIVATION_TOKEN_SECRET');
...
const userCtrl = {
    register: async (req, res) => {
        try {
            ...
            if(password.length < 6)
                ...
                const newUser = new Users ({
                    name, email, password: passwordHash,phoneNumber, description
                });
           ...
           // const url = `${CLIENT_URL}/user/db/activate/${activation_token}`
        ...
        /*  activateEmail: async (req, res) => {
            try {
                ...
                const {name, email, password, phoneNumber, description} = user
    ...
    forgotPassword: async (req, res) => {
        try {
            ...
            const url = `${CLIENT_URL}/user/db/reset/${access_token}`
    ...
    logout: async (req, res) => {
        try {
            res.clearCookie('refreshtoken', {path: '/user/db/refresh_token'})
  ...
  /* googleLogin: async (req, res) => {
        try {
            ...
            if(user){
                ...
                const newUser = new Users({
                    name, email, password: passwordHash, avatar: picture , phoneNumber, description
                })
   ...
   facebookLogin: async (req, res) => {
        try {
            ...
            if(user){
                ...
                const newUser = new Users({
                    name, email, password: passwordHash, avatar: picture.data.url , phoneNumber, description
                })
